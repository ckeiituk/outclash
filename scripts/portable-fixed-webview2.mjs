...
async function resolvePortable() {
  ...
  zip.addLocalFile(path.join(releaseDir, "OutClash.exe"));
  zip.addLocalFile(path.join(releaseDir, "out-mihomo.exe"));
  zip.addLocalFile(path.join(releaseDir, "out-mihomo-alpha.exe"));
