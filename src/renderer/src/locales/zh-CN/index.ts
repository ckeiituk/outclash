export default {
  ...
  guide: {
    ...
    profileImport: '订阅导入',
    profileImportDesc:
      'OutClash 支持多种订阅导入方式，在此输入订阅链接，点击导入即可导入您的订阅配置，如果您的订阅需要代理才能更新，请勾选"代理"再点击导入，当然这需要已经有一个可以正常使用的订阅才可以',
    localProfile: '本地订阅',
    ...
    tunSettings: '虚拟网卡设置',
    tunSettingsDesc:
      '这里可以更改虚拟网卡相关设置，OutClash 理论上已经完全解决权限问题，如果您的虚拟网卡仍然不可用，可以尝试重设防火墙（Windows）或手动授权内核（MacOS/Linux）后重启内核',
    dnsDesc:
  ...
  profile: {
    ...
    urlPlaceholderWithShareLink: '订阅链接或代理链接 (ss://, vmess://, vless://, trojan://)',
    template: '模板',
    templateDefault: '默认 (RU 规则)',
    templateWithoutRu: '国际',
